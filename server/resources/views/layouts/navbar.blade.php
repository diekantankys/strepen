<div class="navbar is-fixed-top">
    <div class="container">
        <div class="navbar-brand">
            <a @class(['navbar-item', 'is-active' => Route::is('home') || Route::is('posts.show'), 'has-text-weight-bold']) href="{{ route('home') }}">
            ...
            @auth
                ...
                @else
                        ...
                        @if (Auth::user()->manager)
                            <div class="navbar-item has-dropdown is-hoverable">
                                ...
                                <div class="navbar-dropdown">
                                    @if (Auth::user()->admin)
                                        <a @class(['navbar-item', 'is-active' => Route::is('admin.settings')]) href="{{ route('admin.settings') }}">@lang('layout.navbar.admin_settings')</a>
                                        <a @class(['navbar-item', 'is-active' => Route::is('admin.api_keys.crud')]) href="{{ route('admin.api_keys.crud') }}">@lang('layout.navbar.admin_api_keys')</a>
                                    @endif
                                    <a @class(['navbar-item', 'is-active' => Route::is('admin.users.crud')]) href="{{ route('admin.users.crud') }}">@lang('layout.navbar.admin_users')</a>
                                    <a @class(['navbar-item', 'is-active' => Route::is('admin.posts.crud')]) href="{{ route('admin.posts.crud') }}">@lang('layout.navbar.admin_posts')</a>
                                    <a @class(['navbar-item', 'is-active' => Route::is('admin.products.crud')]) href="{{ route('admin.products.crud') }}">@lang('layout.navbar.admin_products')</a>
                                    <a @class(['navbar-item', 'is-active' => Route::is('admin.inventories.crud')]) href="{{ route('admin.inventories.crud') }}">@lang('layout.navbar.admin_inventories')</a>
                                    <a @class(['navbar-item', 'is-active' => Route::is('admin.transactions.crud')]) href="{{ route('admin.transactions.crud') }}">@lang('layout.navbar.admin_transactions')</a>
                                </div>
                            </div>
                        @endif
                    </div>
                    ...
                    <div class="navbar-end">
                        ...
                        <a @class(['navbar-item', 'is-active' => Route::is('balance')]) href="{{ route('balance') }}" style="display: flex; align-items: center;">

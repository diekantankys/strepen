...
return [
    ...
    'crud.firstname_desc' => 'Firstname (Z - A)',
    'crud.created_at_desc' => 'Created at (new - old)',
    'crud.created_at_asc' => 'Created at (old - new)',
    'crud.balance_desc' => 'Balance (high - low)',
    'crud.balance_asc' => 'Balance (low - high)',
    'crud.users' => 'users',
    ...
    'crud.theme_system' => 'Use system default',
    'crud.check_balances' => 'Check users balances',
    'crud.check_description' => 'Are you sure you want to check all the user balances, this can send out (email) notifications?',
    ...
    'crud.total' => 'Total',
    'crud.not_debtor_total' => 'Not debtors total',
    'crud.cancel' => 'Cancel',
    ...
    'item.gender_unknown' => 'Gender unknown',
    'item.birthday_unknown' => 'Birthday unknown',
    'item.contact_info' => 'Contact information',
    'item.phone_unknown' => 'Phone number unknown',
    'item.address_info' => 'Address information',
    'item.address_unknown' => 'Address unknown',
    ...
    'item.theme_system' => 'Use system default',
    'item.notify_new_posts' => 'Receive news',
    'item.notify_new_posts_user' => 'Receive notifications when a new news post is placed',
    'item.active' => 'Active',

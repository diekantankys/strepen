...
return [
    // Admin transactions crud livewire component
    'crud.title' => 'Transactions - Admin',
    'crud.header' => 'Transactions',
    'crud.create_transaction' => 'Create new transaction',
    'crud.create_deposit' => 'Create new deposits',
    'crud.create_deposit_small' => 'Deposit',
    'crud.create_payment' => 'Create new payments',
    'crud.create_payment_small' => 'Payment',
    ...
    'crud.price_desc' => 'Price (high - low)',
    'crud.price_asc' => 'Price (low - high)',
    ...
    'crud.name_default_payment' => 'Payment on',
    'crud.single' => 'Single',
    'crud.multiple' => 'Multiple',
    'crud.amount' => 'Amount',
    'crud.send_notification' => 'Send (email) notification to user',
    'crud.cancel' => 'Cancel',
    ...
    'item.payment_for' => 'Payment for :user.name on :transaction.created_at',
    'item.amount' => 'Amount',
    'item.edit' => 'Edit',
    'item.delete' => 'Delete',

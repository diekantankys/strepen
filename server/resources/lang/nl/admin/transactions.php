...
return [
    ...
    'crud.title' => 'Transacties - Admin',
    'crud.header' => 'Transacties',
    'crud.create_transaction' => 'Maak nieuwe transactie',
    'crud.create_deposit' => 'Maak nieuwe stortingen',
    'crud.create_deposit_small' => 'Storting',
    'crud.create_payment' => 'Maak nieuwe betalingen',
    'crud.create_payment_small' => 'Betaling',
    ...
    'crud.name_default_payment' => 'Betaling op',
    'crud.single' => 'Enkel',
    ...
    'item.payment_for' => 'Betaling voor :user.name op :transaction.created_at',
    'item.amount' => 'Hoeveelheid',
    'item.edit' => 'Aanpassen',
    'item.delete' => 'Verwijderen',
    'item.edit_transaction' => 'Pas transactie aan',
    'item.name' => 'Naam',
